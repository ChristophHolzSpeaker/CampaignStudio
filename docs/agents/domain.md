...
- **Context-scoped ADRs**, such as `worker/docs/adr/`, for decisions local to that context.
...
/
├── CONTEXT-MAP.md
├── CONTEXT.md                         ← SvelteKit application and shared product domain
├── docs/adr/                          ← system-wide decisions
└── worker/
    ├── CONTEXT.md                     ← Cloudflare Worker domain
