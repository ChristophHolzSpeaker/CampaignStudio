-- Add Google Ads campaign tables that mirror generated ad packages
...
create table campaign_ad_groups (
	id serial primary key,
	ad_package_id integer not null references campaign_ad_packages(id) on delete cascade,
...
create table campaign_keywords (
	id serial primary key,
	ad_group_id integer not null references campaign_ad_groups(id) on delete cascade,
